...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [18] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 5, 0, 0),
  [20] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [22] = {.entry = {.count = 1, .reusable = false}}, SHIFT(20),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 7, 0, 0),
  [26] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [28] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [30] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 3, 0, 0),
